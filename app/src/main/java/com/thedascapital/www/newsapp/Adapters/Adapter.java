package com.thedascapital.www.newsapp.Adapters;
...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, int i) {
        ...
        holder.time.setText("\u2022"+ DataUtils.DateToTimeFormat(model.getPublishedAt()));
        holder.publishedAt.setText(DataUtils.DateFormat(model.getPublishedAt()));
